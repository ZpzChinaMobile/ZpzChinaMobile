...
-(void)getSecondView{
    ...
    NSArray* ary2=@[@[tempAry[0],[NSString stringWithFormat:@"%@层",dataDic[@"storeyHeight"]],[dataDic[@"foreignInvestment"] isEqualToString:@"1"]?@"Yes":@"No"],@[tempAry[1],[NSString stringWithFormat:@"%@百万",dataDic[@"investment"]],[NSString stringWithFormat:@"%@㎡",dataDic[@"areaOfStructure"]]]];
